 ...
 */
 module App = {
  ...
  let make = () => {
     ...
     * placeholders inside the curly braces (e.g., `ocaml_twixt_front`) will be replaced 
    ...
    let configuration =
      Cma_configuration.Configuration.make(
        ~name="ocaml_twixt_front",
        ~directory="/home/lucas/ocaml_twixt/front/ocaml_twixt_front",
